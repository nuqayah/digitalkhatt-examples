...
export let style = 'line-height: 3; width: 350px'

const LINE_HEIGHT = 1.8
const defaultSize = (1000 / 4600) * 72.0 // 15.65 pt = 20.869 px
const FACTOR = 30
...
function drawText() {
    ...
    quranShaper.shapeText(text, wd, scale / 1.3, just, tajweed, fontExpansion, ctx)
}
</script>
